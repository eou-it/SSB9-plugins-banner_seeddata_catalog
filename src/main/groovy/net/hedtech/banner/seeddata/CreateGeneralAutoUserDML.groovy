...
public class CreateGeneralAutoUserDML {
    ...
    public CreateGeneralAutoUserDML(InputData connectInfo, Sql conn, Connection connectCall) {
        this.conn = conn
    ...
    public CreateGeneralAutoUserDML(InputData connectInfo, Sql conn, Connection connectCall, xmlData) {
