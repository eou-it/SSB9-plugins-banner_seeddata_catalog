...
public class InputData {
    ...
    def targets = [
            ...
            'api-finance'                        : ['/src/main/groovy/net/hedtech/banner/seeddata/Data/api/finance/FABCHKS_FABINCK_Data.xml',
                                                    ...
                                                    '/src/main/groovy/net/hedtech/banner/seeddata/Data/api/finance/API_FTVATYP_Data.xml',
                                                    '/src/main/groovy/net/hedtech/banner/seeddata/Data/api/finance/API_FOBSYSC_Data.xml'],
