    ...
    def processTVRBDTL() {
        ...
        if (newPage) {
            ...
            if (newPage.TVRBDTL_TRAN_NUMBER?.text()) {
                this.tvrbdtl_tran_number = newPage.TVRBDTL_TRAN_NUMBER.text()
            }
