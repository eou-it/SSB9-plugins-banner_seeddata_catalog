...
public class InputData {
    ...
    def targets = [
            ...
            'academic-history-seeddata'        : ['/src/groovy/net/hedtech/banner/seeddata/Data/history/SeedData_GTVDICD.xml',
                                                  ...
                                                  '/src/groovy/net/hedtech/banner/seeddata/Data/history/SeedData_201763_Term.xml',
