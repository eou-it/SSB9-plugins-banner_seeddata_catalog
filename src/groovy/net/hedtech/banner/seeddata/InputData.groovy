...
public class InputData {
    ...
    def targets = [
            ...
            'finance-procurement': ['/src/groovy/net/hedtech/banner/seeddata/Data/finance/PurchaseRequisitionHeader1.xml'],
            'finance-procurement-api': ['/src/groovy/net/hedtech/banner/seeddata/Data/finance/PurchaseRequisitionHeader.xml'],
