...
public class InputData {
    ...
    def targets = [
            ...
            'studentApiData': ['/src/groovy/net/hedtech/banner/seeddata/Data/ApiDeriveTerm.xml',
                                ...
                                '/src/groovy/net/hedtech/banner/seeddata/Data/ApiIntegrationConfigurationData_Master.xml',
           ...
           // 'goriccr' : ['/src/groovy/net/hedtech/banner/seeddata/Data/ApiIntegrationConfigurationData_Current.xml'],
