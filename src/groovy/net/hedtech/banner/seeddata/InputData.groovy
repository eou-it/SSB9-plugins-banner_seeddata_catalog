...
public class InputData {
    ...
    def targets = [
            ...
            'droproster'                        : ['/src/groovy/net/hedtech/banner/seeddata/Data/history/DropRosterScheduleData.xml',
                                                  ...
                                                  '/src/groovy/net/hedtech/banner/seeddata/Data/history/SFBRORL.xml',
                                                  '/src/groovy/net/hedtech/banner/seeddata/Data/history/SFBRORLClean.xml'],
            ...
            'finance-budget-availability-data' : ['src/groovy/net/hedtech/banner/seeddata/Data/finance/budgetavailability/FinanceFoapalAccountIndex.xml',
												  ...
												  'src/groovy/net/hedtech/banner/seeddata/Data/finance/budgetavailability/FinanceBudgetMultiyearTransactionalDetailsFGBTRNH.xml',
                                                  'src/groovy/net/hedtech/banner/seeddata/Data/finance/budgetavailability/FinanceBudgetMultiyearTransactionalDetailsFGBTRND.xml',
                                                  'src/groovy/net/hedtech/banner/seeddata/Data/finance/budgetavailability/FinanceBudgetMultiyearTransactionalDetailsFTVFUND.xml'],
