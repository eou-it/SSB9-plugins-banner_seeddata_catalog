...
public class APIClasses {
    ...
    def API = [
            ...
            'FGBTRNH'               : 'net.hedtech.banner.seeddata.FinanceBudgetAvailabilityTransactionHistoryDML',
            'FGBTRND'               : 'net.hedtech.banner.seeddata.FinanceBudgetAvailabilityTransactionDetailsDML',
