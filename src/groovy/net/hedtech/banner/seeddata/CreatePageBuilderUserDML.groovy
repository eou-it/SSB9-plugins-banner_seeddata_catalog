...
public class CreatePageBuilderUserDML {
    ...
    public CreatePageBuilderUserDML(InputData connectInfo, Sql conn, Connection connectCall) {
        this.conn = conn
    ...
    public CreatePageBuilderUserDML(InputData connectInfo, Sql conn, Connection connectCall, xmlData) {
    ...
    def createUserId() {
        ...
        if (result.cnt == 0) {
            ...
            if (readonly == "YES") {
                ...
                sql2 = "grant connect, resource, ban_default_q, ban_default_m, BAN_DEFAULT_PAGEBUILDER_M to " + newOracleId
            }
