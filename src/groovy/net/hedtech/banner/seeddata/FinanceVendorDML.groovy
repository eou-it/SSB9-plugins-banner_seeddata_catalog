...
public class FinanceVendorDML {
    ...
    public FinanceVendorDML(InputData connectInfo, Sql conn, Connection connectCall ) {
    ...
    public FinanceVendorDML(InputData connectInfo, Sql conn, Connection connectCall, xmlData ) {
        this.connectInfo = connectInfo
        ...
        try {
            final String apiQuery =
                    "DECLARE\n" +
                            ...
                            "    LOOP\n" +
                            "      GV_PIDM := F_CREATE_BANNER_ID (ORACLE_ID, SPRIDEN_ID, NULL, vendor_name||ind);\n" +
                            "      INSERT\n" +
                            "      INTO FTVVEND\n" +
                            "        (\n" +
                            "          FTVVEND_PIDM,\n" +
