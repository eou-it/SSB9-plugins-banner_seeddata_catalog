...
public class GcrfldrDML {
    ...
    def deleteData() {
        ...
        deleteData("GCRFLDR", "delete from GCRFLDR where GCRFLDR_surrogate_id = ? and  NOT EXISTS (SELECT a.gcbactm_gcrafldr_id FROM gcbactm a WHERE a.gcbactm_gcrafldr_id = gcrfldr_surrogate_id) ")
