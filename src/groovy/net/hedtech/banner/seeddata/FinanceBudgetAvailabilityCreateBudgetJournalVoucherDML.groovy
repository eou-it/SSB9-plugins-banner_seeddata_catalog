        ...
        try {
            final String apiQuery =
                    "DECLARE\n" +
                            ...
                            "  BEGIN\n" +
                            "    l_fund_code       := 'F' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "    l_orgn_code       := 'O' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "    l_acct_code       := 'A' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "    l_prog_code       := 'P' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "    IF mod(foap_code,2)< 1 THEN\n" +
                            "      l_actv_code     := 'T' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "      l_locn_code     := 'L' || TRIM(TO_CHAR(foap_code, '00099'));\n" +
                            "    ELSE\n" +
                            "      l_actv_code := NULL;\n" +
                            "      l_locn_code := NULL;\n" +
                            "    END IF;\n" +
